...
bundle rat_add_syntax begin notation rat_add (infixl "+" 65) end
bundle no_rat_add_syntax begin no_notation rat_add (infixl "+" 65) end

bundle rat_sub_syntax begin notation rat_sub (infixl "-" 65) end
bundle no_rat_sub_syntax begin no_notation rat_sub (infixl "-" 65) end

bundle rat_mul_syntax begin notation rat_mul (infixl "*" 65) end
bundle no_rat_div_syntax begin no_notation rat_div (infixl "'/" 65) end

bundle rat_div_syntax begin notation rat_div (infixl "'/" 65) end
bundle no_rat_mul_syntax begin no_notation rat_mul (infixl "*" 65) end
...
lemma [transfer_rule]: "(Rat_Rel ===> Rat_Type_Rel ===> (=)) (\<in>) (has_type)"
  ...
  by (metis mem_iff_Element Dep_fun_typeE Rat.Rep_type)
