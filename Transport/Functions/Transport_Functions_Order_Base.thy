...
lemma reflexive_on_in_domI:
  ...
  and pequiv_R: "\<And>x1 x2. x1 \<le>\<^bsub>L\<^esub> x2 \<Longrightarrow> partial_equivalence (\<le>\<^bsub>R x1 x2\<^esub>)"
...
lemma preorder_on_in_fieldI:
  ...
  (auto intro!: transitiveI dest: pequiv_R elim!: partial_equivalenceE)
...
lemma partial_equivalence_left2_if_partial_equivalence_left2_if_GaloisI:
  assumes "((\<le>\<^bsub>L1\<^esub>) \<Rrightarrow>\<^sub>m (\<le>\<^bsub>R1\<^esub>)) l1"
  and "((\<le>\<^bsub>L1\<^esub>) \<unlhd>\<^sub>h (\<le>\<^bsub>R1\<^esub>)) l1 r1"
  and L2_eq: "(\<le>\<^bsub>L2 x1 x2\<^esub>) = (\<le>\<^bsub>L2 x1 (\<eta>\<^sub>1 x2)\<^esub>)"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> partial_equivalence (\<le>\<^bsub>L2 x (r1 x')\<^esub>)"
  and "x1 \<le>\<^bsub>L1\<^esub> x2"
  shows "partial_equivalence (\<le>\<^bsub>L2 x1 x2\<^esub>)"
  by (subst L2_eq) (auto intro!: assms t1.Galois_left_if_left_relI)
...
interpretation flip_inv :
  ...
  and "\<And>R. partial_equivalence R\<inverse> \<equiv> partial_equivalence R"
...
lemma partial_equivalence_right2_if_partial_equivalence_right2_if_GaloisI:
  assumes "((\<le>\<^bsub>R1\<^esub>) \<Rrightarrow>\<^sub>m (\<le>\<^bsub>L1\<^esub>)) r1"
  and "(\<le>\<^bsub>R2 x1 x2\<^esub>) = (\<le>\<^bsub>R2 (\<epsilon>\<^sub>1 x1) x2\<^esub>)"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> partial_equivalence (\<le>\<^bsub>R2 (l1 x) x'\<^esub>)"
  and "x1 \<le>\<^bsub>R1\<^esub> x2"
  shows "partial_equivalence (\<le>\<^bsub>R2 x1 x2\<^esub>)"
  using galois_prop assms
  by (intro flip_inv.partial_equivalence_left2_if_partial_equivalence_left2_if_GaloisI
    [simplified rel_inv_iff_rel, of x1])
  auto
...
lemma symmetric_left2_if_partial_equivalence_equivalenceI:
...
lemma partial_equivalence_left2_if_partial_equivalence_equivalenceI:
  assumes PER_equiv1: "((\<le>\<^bsub>L1\<^esub>) \<equiv>\<^bsub>PER\<^esub> (\<le>\<^bsub>R1\<^esub>)) l1 r1"
  and "([x1 x2 \<Colon> (\<ge>\<^bsub>L1\<^esub>)] \<Rrightarrow>\<^sub>m [x3 x4 \<Colon> (\<le>\<^bsub>L1\<^esub>) | x1 \<le>\<^bsub>L1\<^esub> x3] \<Rrightarrow> (\<le>)) L2"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> ((\<le>\<^bsub>L2 x (r1 x')\<^esub>) \<equiv>\<^bsub>PER\<^esub> (\<le>\<^bsub>R2 (l1 x) x'\<^esub>)) (l2\<^bsub>x' x\<^esub>) (r2\<^bsub>x x'\<^esub>)"
  and "x1 \<le>\<^bsub>L1\<^esub> x2"
...
proof -
  ...
  with assms have "(\<le>\<^bsub>L2 x1 x2\<^esub>) = (\<le>\<^bsub>L2 x1 (\<eta>\<^sub>1 x2)\<^esub>)"
    by (intro left2_eq_if_bi_related_if_monoI) blast+
  with assms show ?thesis
    by (intro partial_equivalence_left2_if_partial_equivalence_left2_if_GaloisI[of x1])
    blast+
qed
...
lemma symmetric_right2_if_partial_equivalence_equivalenceI:
  assumes PER_equiv1: "((\<le>\<^bsub>L1\<^esub>) \<equiv>\<^bsub>PER\<^esub> (\<le>\<^bsub>R1\<^esub>)) l1 r1"
  and "([x1' x2' \<Colon> (\<ge>\<^bsub>R1\<^esub>)] \<Rrightarrow>\<^sub>m [x3' x4' \<Colon> (\<le>\<^bsub>R1\<^esub>) | x1' \<le>\<^bsub>R1\<^esub> x3'] \<Rrightarrow> (\<le>)) R2"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> ((\<le>\<^bsub>L2 x (r1 x')\<^esub>) \<equiv>\<^bsub>PER\<^esub> (\<le>\<^bsub>R2 (l1 x) x'\<^esub>)) (l2\<^bsub>x' x\<^esub>) (r2\<^bsub>x x'\<^esub>)"
  and "x1' \<le>\<^bsub>R1\<^esub> x2'"
...
lemma partial_equivalence_right2_if_partial_equivalence_equivalenceI:
  assumes PER_equiv1: "((\<le>\<^bsub>L1\<^esub>) \<equiv>\<^bsub>PER\<^esub> (\<le>\<^bsub>R1\<^esub>)) l1 r1"
  and "([x1' x2' \<Colon> (\<ge>\<^bsub>R1\<^esub>)] \<Rrightarrow>\<^sub>m [x3' x4' \<Colon> (\<le>\<^bsub>R1\<^esub>) | x1' \<le>\<^bsub>R1\<^esub> x3'] \<Rrightarrow> (\<le>)) R2"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> ((\<le>\<^bsub>L2 x (r1 x')\<^esub>) \<equiv>\<^bsub>PER\<^esub> (\<le>\<^bsub>R2 (l1 x) x'\<^esub>)) (l2\<^bsub>x' x\<^esub>) (r2\<^bsub>x x'\<^esub>)"
  and "x1' \<le>\<^bsub>R1\<^esub> x2'"
...
proof -
  ...
  with assms have "(\<le>\<^bsub>R2 x1' x2'\<^esub>) = (\<le>\<^bsub>R2 (\<epsilon>\<^sub>1 x1') x2'\<^esub>)"
    by (intro flip.left2_eq_if_bi_related_if_monoI) blast+
  with assms show ?thesis
    by (intro partial_equivalence_right2_if_partial_equivalence_right2_if_GaloisI[of x1'])
    blast+
qed
...
corollary partial_equivalence_leftI:
  assumes "reflexive_on (in_field (\<le>\<^bsub>L1\<^esub>)) (\<le>\<^bsub>L1\<^esub>)"
  and "symmetric (\<le>\<^bsub>L1\<^esub>)"
  and "partial_equivalence (\<le>\<^bsub>L2\<^esub>)"
  shows "partial_equivalence (\<le>\<^bsub>L\<^esub>)"
  using assms by (intro tdfr.partial_equivalence_leftI) auto
...
lemmas partial_equivalence_leftI = Refl_Rel_partial_equivalenceI[of tdfr.L,
  OF tdfr.partial_equivalence_leftI, folded left_rel_eq_tdfr_left_Refl_Rel]
...
lemma partial_equivalence_leftI:
  ...
  and "partial_equivalence (\<le>\<^bsub>L2\<^esub>)"
  shows "partial_equivalence (\<le>\<^bsub>L\<^esub>)"
  using assms by (intro tpdfr.partial_equivalence_leftI) auto
