...
interpretation flip_inv :
  ...
  and "flip_inv.g1.unit \<equiv> \<epsilon>\<^sub>1"
  and "\<And>x y. flip_inv.g2_unit x y \<equiv> \<epsilon>\<^bsub>2 y x\<^esub>"
  ...
  by (simp_all add: flip_inv_left_eq_ge_right flip_inv_right_eq_ge_left
    flip_unit_eq_counit g1.flip_unit_eq_counit g2.flip_unit_eq_counit
...
lemma inflationary_on_unitI:
  assumes "(t.L \<Rrightarrow>\<^sub>m t.R) l" and "(t.R \<Rrightarrow>\<^sub>m t.L) r"
  ...
  unfolding left_rel_eq_Refl_Rel using assms
  by (intro inflationary_onI Refl_RelI)
  (auto intro: t.rel_unit_self_if_rel_selfI[simplified unit_eq] elim!: Refl_RelE)
...
lemma deflationary_on_counitI:
  ...
  unfolding right_rel_eq_Refl_Rel using assms
  by (intro deflationary_onI Refl_RelI)
  (auto intro: t.counit_rel_self_if_rel_selfI[simplified counit_eq] elim!: Refl_RelE)
...
interpretation flip : transport_Refl_Rel_Dep_Fun_Rel_rel R1 L1 r1 l1 R2 L2 r2 l2
  rewrites "flip.counit \<equiv> \<eta>" and "flip.g1.counit \<equiv> \<eta>\<^sub>1"
  and "\<And>x y. flip.g2_counit x y \<equiv> \<eta>\<^bsub>2 y x\<^esub>"
...
lemma rel_equivalence_on_unitI:
  ...
  and trans_L1: "transitive (\<le>\<^bsub>L1\<^esub>)"
  and "\<And>x. x \<le>\<^bsub>L1\<^esub> x \<Longrightarrow> ((\<le>\<^bsub>L2 x x\<^esub>) \<Rrightarrow>\<^sub>m (\<le>\<^bsub>R2 (l1 x) (l1 x)\<^esub>)) (l2\<^bsub>(l1 x) x\<^esub>)"
  and r2_mono: "\<And>x. x \<le>\<^bsub>L1\<^esub> x \<Longrightarrow> ((\<le>\<^bsub>R2 (l1 x) (l1 x)\<^esub>) \<Rrightarrow>\<^sub>m (\<le>\<^bsub>L2 x x\<^esub>)) (r2\<^bsub>x (l1 x)\<^esub>)"
...
proof -
  have "((\<le>\<^bsub>R2 (l1 x) (l1 x)\<^esub>) \<Rrightarrow>\<^sub>m (\<le>\<^bsub>L2 x (\<eta>\<^sub>1 x)\<^esub>)) (r2\<^bsub>x (l1 x)\<^esub>)"
  ...
  proof -
    ...
    with r2_mono show "((\<le>\<^bsub>R2 (l1 x) (l1 x)\<^esub>) \<Rrightarrow>\<^sub>m (\<le>\<^bsub>L2 x (\<eta>\<^sub>1 x)\<^esub>)) (r2\<^bsub>x (l1 x)\<^esub>)"
      and "((\<le>\<^bsub>R2 (l1 x) (l1 x)\<^esub>) \<Rrightarrow>\<^sub>m (\<le>\<^bsub>L2 (\<eta>\<^sub>1 x) x\<^esub>)) (r2\<^bsub>x (l1 x)\<^esub>)"
      using L2_le1 L2_le2 by blast+
  qed (insert rel_equiv_unit2, blast+)
  moreover from rel_equiv_unit1 trans_L1 have "reflexive_on (in_field (\<le>\<^bsub>L1\<^esub>)) (\<le>\<^bsub>L1\<^esub>)"
...
interpretation flip : transport_Refl_Rel_Dep_Fun_Rel_rel R1 L1 r1 l1 R2 L2 r2 l2
  ...
  and "flip.counit \<equiv> \<eta>" and "flip.g1.counit \<equiv> \<eta>\<^sub>1"
  and "\<And>x y. flip.g2_unit x y \<equiv> \<epsilon>\<^bsub>2 y x\<^esub>"
  by (simp_all add: order_functors.flip_counit_eq_unit)

lemma order_equivalenceI:
  assumes "(t.L \<Rrightarrow>\<^sub>m t.R) l"
  and "(t.R \<Rrightarrow>\<^sub>m t.L) r"
...
lemma order_equivalence_if_order_equivalenceI:
  assumes order_equiv1: "((\<le>\<^bsub>L1\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R1\<^esub>)) l1 r1"
  and trans_L1: "transitive (\<le>\<^bsub>L1\<^esub>)" and trans_R1: "transitive (\<le>\<^bsub>R1\<^esub>)"
  ...
  and L2_le1: "\<And>x1 x2. x1 \<le>\<^bsub>L1\<^esub> x2 \<Longrightarrow> (\<le>\<^bsub>L2 x2 x2\<^esub>) \<le> (\<le>\<^bsub>L2 x1 x2\<^esub>)"
  and L2_unit_le1: "\<And>x1 x2. x1 \<le>\<^bsub>L1\<^esub> x2 \<Longrightarrow> (\<le>\<^bsub>L2 (\<eta>\<^sub>1 x1) x2\<^esub>) \<le> (\<le>\<^bsub>L2 x1 x2\<^esub>)"
  and L2_le2: "\<And>x1 x2. x1 \<le>\<^bsub>L1\<^esub> x2 \<Longrightarrow> (\<le>\<^bsub>L2 x1 x1\<^esub>) \<le> (\<le>\<^bsub>L2 x1 x2\<^esub>)"
  and L2_unit_le2: "\<And>x1 x2. x1 \<le>\<^bsub>L1\<^esub> x2 \<Longrightarrow> (\<le>\<^bsub>L2 x1 (\<eta>\<^sub>1 x2)\<^esub>) \<le> (\<le>\<^bsub>L2 x1 x2\<^esub>)"
  ...
  and R2_counit_le2: "\<And>x1' x2'. x1' \<le>\<^bsub>R1\<^esub> x2' \<Longrightarrow> (\<le>\<^bsub>R2 x1' (\<epsilon>\<^sub>1 x2')\<^esub>) \<le> (\<le>\<^bsub>R2 x1' x2'\<^esub>)"
  ...
  shows "((\<le>\<^bsub>L\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R\<^esub>)) l r"
proof -
  have L2_unit_eq1: "(\<le>\<^bsub>L2 (\<eta>\<^sub>1 x) x\<^esub>) = (\<le>\<^bsub>L2 x x\<^esub>)" (is ?goal1)
    and L2_unit_eq2: "(\<le>\<^bsub>L2 x (\<eta>\<^sub>1 x)\<^esub>) = (\<le>\<^bsub>L2 x x\<^esub>)" (is ?goal2)
    if [iff]: "x \<le>\<^bsub>L1\<^esub> x" for x
  proof -
    from order_equiv1 have "x \<equiv>\<^bsub>L1\<^esub> \<eta>\<^sub>1 x" by blast
    with L2_le1 L2_unit_le1 show ?goal1 by blast
    from \<open>x \<equiv>\<^bsub>L1\<^esub> \<eta>\<^sub>1 x\<close> L2_le2 L2_unit_le2 show ?goal2 by blast
  qed
  have R2_counit_eq1: "(\<le>\<^bsub>R2 (\<epsilon>\<^sub>1 x') x'\<^esub>) = (\<le>\<^bsub>R2 x' x'\<^esub>)" (is ?goal1)
    and R2_counit_eq2: "(\<le>\<^bsub>R2 x' (\<epsilon>\<^sub>1 x')\<^esub>) = (\<le>\<^bsub>R2 x' x'\<^esub>)" (is ?goal2)
    if [iff]: "x' \<le>\<^bsub>R1\<^esub> x'" for x'
  proof -
    from order_equiv1 have "\<epsilon>\<^sub>1 x' \<equiv>\<^bsub>R1\<^esub> x'" by blast
    with R2_le1 R2_counit_le1 show ?goal1 by blast
    from \<open>\<epsilon>\<^sub>1 x' \<equiv>\<^bsub>R1\<^esub> x'\<close> R2_le2 R2_counit_le2 show ?goal2 by blast
  qed
  ...
  moreover have "rel_equivalence_on (in_field (\<le>\<^bsub>L2 x x\<^esub>)) (\<le>\<^bsub>L2 x x\<^esub>) (\<eta>\<^bsub>2 x (l1 x)\<^esub>)" (is ?goal1)
    ...
    if [iff]: "x \<le>\<^bsub>L1\<^esub> x" for x
  proof -
    from order_equiv1 have "x \<^bsub>L1\<^esub>\<lessapprox> l1 x"
      by (auto intro!: g1.GaloisI elim!: g1.order_equivalenceE)
  ...
  moreover have
    ...
    if [iff]: "x' \<le>\<^bsub>R1\<^esub> x'" for x'
  proof -
    from order_equiv1 have "r1 x' \<^bsub>L1\<^esub>\<lessapprox> x'" by blast
    ...
    then show ?goal1 ?goal2 by (auto elim: order_functors.order_equivalenceE)
  qed
  moreover from mono_l2 t.mono_wrt_rel_left_mono_asm_if_mono_wrt_rel
    ...
    using order_equiv1 R2_counit_le1 by blast
  moreover from order_equiv1 trans_L1 trans_R1 have "((\<le>\<^bsub>L1\<^esub>) \<unlhd>\<^sub>h (\<le>\<^bsub>R1\<^esub>)) l1 r1"
    by (intro g1.half_galois_prop_right_left_right_if_transitive_if_order_equivalence)
  moreover with mono_r2 t.mono_wrt_rel_right_mono_asm_if_mono_wrt_relI
    ...
    using order_equiv1 by blast
  moreover with L2_unit_le2
  ...
  proof -
    ...
    moreover from order_equiv1 have \<open>l1 x \<le>\<^bsub>R1\<^esub> l1 x\<close> by blast
  ...
  proof -
    ...
    with r2_bi_rel have "r2\<^bsub>(r1 x') (\<epsilon>\<^sub>1 x')\<^esub> y' \<equiv>\<^bsub>L2 (r1 x') (r1 x')\<^esub> r2\<^bsub>(r1 x') x'\<^esub> y'"
      by blast
    moreover from order_equiv1 have \<open>r1 x' \<le>\<^bsub>L1\<^esub> r1 x'\<close> by blast
    ultimately show ?goal1 ?goal2 using trans_L2 by blast+
  qed auto
  ultimately show ?thesis using assms
    by (intro order_equivalenceI
      t.mono_wrt_rel_left_if_transitiveI
      t.mono_wrt_rel_left_mono_asm_if_mono_wrt_rel
      t.mono_wrt_rel_right_if_transitiveI
      t.mono_wrt_rel_right_mono_asm_if_mono_wrt_relI)
    auto
qed
...
lemma order_equivalence_if_order_equivalence_mono_assms_leftI:
  ...
  and "\<And>x1' x2'. x1' \<le>\<^bsub>R1\<^esub> x2' \<Longrightarrow>
    ([in_codom (\<le>\<^bsub>L2 (r1 x1') (r1 x2')\<^esub>)] \<Rrightarrow> (\<le>\<^bsub>R2 x1' x2'\<^esub>)) (l2\<^bsub>x2' (r1 x1')\<^esub>) (l2\<^bsub>x2' (r1 x2')\<^esub>)"
proof -
  fix x1' x2' assume [iff]: "x1' \<le>\<^bsub>R1\<^esub> x2'"
  with refl_R1 have "x1' \<le>\<^bsub>R1\<^esub> x1'" "x2' \<le>\<^bsub>R1\<^esub> x2'" by auto
...
proof -
  fix x1 x2 assume [iff]: "x1 \<le>\<^bsub>L1\<^esub> x2"
  with refl_L1 have "x1 \<le>\<^bsub>L1\<^esub> x1" "x2 \<le>\<^bsub>L1\<^esub> x2" by auto
  moreover with order_equiv1
  ...
  ultimately have "x1 \<^bsub>L1\<^esub>\<lessapprox> l1 x1" "x2 \<^bsub>L1\<^esub>\<lessapprox> l1 x2" using order_equiv1
    by (auto intro!: g1.Galois_left_if_in_codom_if_inflationary_onI)
...
lemma order_equivalence_if_order_equivalenceI':
  ...
  and "\<And>x1 x2. x1 \<le>\<^bsub>R1\<^esub> x2 \<Longrightarrow> transitive (\<le>\<^bsub>R2 x1 x2\<^esub>)"
  shows "((\<le>\<^bsub>L\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R\<^esub>)) l r"
  using assms by (intro order_equivalence_if_order_equivalenceI
    order_equivalence_if_order_equivalence_mono_assms_leftI
    order_equivalence_if_order_equivalence_mono_assms_rightI
    reflexive_on_in_field_if_transitive_if_rel_equivalence_on)
  auto

lemma order_equivalence_if_mono_if_order_equivalenceI:
  assumes order_equiv1: "((\<le>\<^bsub>L1\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R1\<^esub>)) l1 r1"
  and trans_L1: "transitive (\<le>\<^bsub>L1\<^esub>)" and trans_R1: "transitive (\<le>\<^bsub>R1\<^esub>)"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> ((\<le>\<^bsub>L2 x (r1 x')\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R2 (l1 x) x'\<^esub>)) (l2\<^bsub>x' x\<^esub>) (r2\<^bsub>x x'\<^esub>)"
  ...
  shows "((\<le>\<^bsub>L\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R\<^esub>)) l r"
proof -
  have "l2\<^bsub>(l1 x) (\<eta>\<^sub>1 x)\<^esub> y \<equiv>\<^bsub>R2 (l1 x) (l1 x)\<^esub> l2\<^bsub>(l1 x) x\<^esub> y"
    if "x \<le>\<^bsub>L1\<^esub> x" "in_field (\<le>\<^bsub>L2 x x\<^esub>) y" for x y
  proof (rule bi_relatedI)
    from \<open>x \<le>\<^bsub>L1\<^esub> x\<close> order_equiv1 have "l1 x \<le>\<^bsub>R1\<^esub> l1 x" "x \<le>\<^bsub>L1\<^esub> \<eta>\<^sub>1 x" "\<eta>\<^sub>1 x \<le>\<^bsub>L1\<^esub> x"
      by blast+
    with order_equiv1 have "x \<^bsub>L1\<^esub>\<lessapprox> l1 x" "\<eta>\<^sub>1 x \<^bsub>L1\<^esub>\<lessapprox> l1 x" by auto
    from order_equiv1 \<open>x \<le>\<^bsub>L1\<^esub> \<eta>\<^sub>1 x\<close> have "x \<le>\<^bsub>L1\<^esub> \<eta>\<^sub>1 (\<eta>\<^sub>1 x)" using trans_L1 by fast
    ...
    moreover from order_equiv1 \<open>l1 x \<le>\<^bsub>R1\<^esub> l1 x\<close>
      have "\<epsilon>\<^sub>1 (l1 x) \<le>\<^bsub>R1\<^esub> l1 x" "l1 x \<le>\<^bsub>R1\<^esub> \<epsilon>\<^sub>1 (l1 x)" by blast+
  ...
  qed
  moreover have "r2\<^bsub>(r1 x') (\<epsilon>\<^sub>1 x')\<^esub> y' \<equiv>\<^bsub>L2 (r1 x') (r1 x')\<^esub> r2\<^bsub>(r1 x') x'\<^esub> y'"
    if "x' \<le>\<^bsub>R1\<^esub> x'" "in_field (\<le>\<^bsub>R2 x' x'\<^esub>) y'" for x' y'
  proof (rule bi_relatedI)
    from \<open>x' \<le>\<^bsub>R1\<^esub> x'\<close> order_equiv1 have "r1 x' \<le>\<^bsub>L1\<^esub> r1 x'" "x' \<le>\<^bsub>R1\<^esub> \<epsilon>\<^sub>1 x'" "\<epsilon>\<^sub>1 x' \<le>\<^bsub>R1\<^esub> x'"
      by blast+
    with order_equiv1 have "r1 x' \<^bsub>L1\<^esub>\<lessapprox> x'" "r1 x' \<^bsub>L1\<^esub>\<lessapprox> \<epsilon>\<^sub>1 x'" by auto
    from order_equiv1 \<open>x' \<le>\<^bsub>R1\<^esub> \<epsilon>\<^sub>1 x'\<close> have "x' \<le>\<^bsub>R1\<^esub> \<epsilon>\<^sub>1 (\<epsilon>\<^sub>1 x')" using trans_R1 by fast
    ...
    moreover from order_equiv1 \<open>r1 x' \<le>\<^bsub>L1\<^esub> r1 x'\<close>
      have "\<eta>\<^sub>1 (r1 x') \<le>\<^bsub>L1\<^esub> r1 x'" "r1 x' \<le>\<^bsub>L1\<^esub> \<eta>\<^sub>1 (r1 x')" by blast+
    moreover note Dep_Fun_Rel_relD[OF dep_mono_wrt_relD
  ...
  using assms by (intro order_equivalence_if_order_equivalenceI'
    ...
    flip.g1.galois_connection_left_right_if_transitive_if_order_equivalence
    reflexive_on_in_field_if_transitive_if_rel_equivalence_on)
  auto
qed

theorem order_equivalence_if_mono_if_order_equivalenceI':
  assumes "((\<le>\<^bsub>L1\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R1\<^esub>)) l1 r1"
  and "transitive (\<le>\<^bsub>L1\<^esub>)" and "transitive (\<le>\<^bsub>R1\<^esub>)"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> ((\<le>\<^bsub>L2 x (r1 x')\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R2 (l1 x) x'\<^esub>)) (l2\<^bsub>x' x\<^esub>) (r2\<^bsub>x x'\<^esub>)"
  ...
  and "\<And>x1 x2. x1 \<le>\<^bsub>R1\<^esub> x2 \<Longrightarrow> transitive (\<le>\<^bsub>R2 x1 x2\<^esub>)"
  shows "((\<le>\<^bsub>L\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R\<^esub>)) l r"
  using assms by (intro order_equivalence_if_mono_if_order_equivalenceI
...
corollary order_equivalence_if_galois_equivalenceI:
  ...
  and "preorder_on (in_field (\<le>\<^bsub>L1\<^esub>)) (\<le>\<^bsub>L1\<^esub>)" and "preorder_on (in_field (\<le>\<^bsub>R1\<^esub>)) (\<le>\<^bsub>R1\<^esub>)"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> ((\<le>\<^bsub>L2 x (r1 x')\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R2 (l1 x) x'\<^esub>)) (l2\<^bsub>x' x\<^esub>) (r2\<^bsub>x x'\<^esub>)"
  and "([x1 x2 \<Colon> (\<ge>\<^bsub>L1\<^esub>)] \<Rrightarrow>\<^sub>m [x3 x4 \<Colon> (\<le>\<^bsub>L1\<^esub>) | x1 \<le>\<^bsub>L1\<^esub> x3] \<Rrightarrow> (\<le>)) L2"
  and "([x1' x2' \<Colon> (\<ge>\<^bsub>R1\<^esub>)] \<Rrightarrow>\<^sub>m [x3' x4' \<Colon> (\<le>\<^bsub>R1\<^esub>) | x1' \<le>\<^bsub>R1\<^esub> x3'] \<Rrightarrow> (\<le>)) R2"
  and "([x1' x2' \<Colon> (\<le>\<^bsub>R1\<^esub>)] \<Rrightarrow>\<^sub>m [x1 x2 \<Colon> (\<le>\<^bsub>L1\<^esub>) | x2 \<^bsub>L1\<^esub>\<lessapprox> x1'] \<Rrightarrow>
  ...
  shows "((\<le>\<^bsub>L\<^esub>) \<equiv>\<^sub>o (\<le>\<^bsub>R\<^esub>)) l r"
  using assms by (intro order_equivalence_if_mono_if_order_equivalenceI'
    g1.order_equivalence_if_reflexive_on_in_field_if_galois_equivalence)
  auto
