...
(*We can rewrite the Galois relators in the following theorems to
the relator of the paper:*)
...
(*proof of parametricity for max_list*)
...
(*use "print_theorems" to show all theorems*)
(*print_theorems*)
...
(*Registration of symmetric equivalence rules is not done by default as of know,
but would not be a problem in principle.*)
...
(*the framework also provides a simplified definition*)
